                ...
                foreach (var productListItem in productListItems)
                {
                    ...
                    foreach (var productListItem2 in productListItems2)
                    {
                        ...
                        if (price != "")
                        {
                            ...
                            var singleItem = new Item { Picture = "https://www.rde.lt/" + imgLink, Seller = "Rde", Name = name, PriceDouble = pricea, Price = price, Link = "https://www.rde.lt/" + link };
                ...
                foreach (var productListItem in productListItems)
                    if (countItems != 0)
                    {
                        ...
                        if (price != "")
                        {
                            ...
                            var item1 = new Item { Picture = "https://pagrindinis.barbora.lt/" + imgLink, Seller = "Barbora", Name = name, PriceDouble = pricea, Price = price, Link = "https://pagrindinis.barbora.lt/" + link };
                            prices.Add(item1);
                        }
            ...
            if (productListItems != null)
            {
                foreach (var productListItem in productListItems)
                {
                    ...
                    if (price != "")
                    {
                        ...
                        priceAtsarg = PasalinimasEuroSimbol(priceAtsarg);
                        var pricea = Convert.ToDouble(priceAtsarg);
                        var singleItem = new Item { Picture = imgLink, Seller = "BigBox", Name = name, PriceDouble = pricea, Price = price, Link = link };
        ...
        private static void WriteDataFromElektromarkt(List<HtmlNode> productListItems2, List<Item> prices)
        {
            if (productListItems2 != null)
            {
                foreach (var productListItem in productListItems2)
                {
                    ...
                    var item1 = new Item { Picture = imgLink, Seller = "Elektromarkt", Name = name, PriceDouble = pricea, Price = price, Link = link };
                    prices.Add(item1);
            ...
            if (productListItems != null)
            {
                foreach (var productListItem in productListItems)
                {
                    ...
                    if (price != "")
                    {
                        ...
                        var singleItem = new Item { Picture = imgLink, Seller = "Gintarine vaistine", Name = name, PriceDouble = pricea, Price = price + '€', Link = "https://www.gintarine.lt/" + link };
                        prices.Add(singleItem);
                    }
                }
            }
