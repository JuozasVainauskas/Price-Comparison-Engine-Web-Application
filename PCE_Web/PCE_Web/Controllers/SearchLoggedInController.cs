...
namespace PCE_Web.Controllers
{
    ...
    public class SearchLoggedInController : Controller
    {
        ...
        public SearchLoggedInController(IHttpClientFactory httpClient,
            ISavedItemsManager savedItemsManager, IProductsCache productsCache, IExceptionsManager exceptionsManager)
        {
        ...
        public async Task<IActionResult> Suggestions(string productName,
            string link, string pictureUrl, string seller, string name, string price, int page)
        {
